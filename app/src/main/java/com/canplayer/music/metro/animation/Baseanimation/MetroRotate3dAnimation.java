 ...
 */
public class MetroRotate3dAnimation extends Animation {
    ...
    @Deprecated
    public MetroRotate3dAnimation(float[] fromDegrees, float[] toDegrees,
        ...
        mReverse = reverse;
        // 获取手机像素密度 （即dp与px的比例）
        scale = context.getResources().getDisplayMetrics().density*1.5f;
    }
    ...
    protected void applyTransformation(float interpolatedTime, Transformation t) {
        ...
        matrix.preTranslate(-centerX, -centerY); // 使用将旋转中心移动到和Camera位置相同
